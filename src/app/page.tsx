  ...
  return (
    <>
      <div className="">
        ...
        <section className="bg-white px-6 py-12 md:py-24 md:h-[812px] h-[1000px] flex items-center justify-center">
          <div className="mx-auto max-w-7xl flex flex-col-reverse md:grid md:grid-cols-2 gap-12 items-center">
        ...
        <section className="px-6  bg-white text-center md:h-[931px] py-10 ">
          {/* Header */}
          ...
          <div className="flex items-center justify-center  ">
            {/* Grid */}
            <div className="grid  grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-6xl mx-auto  items-center justify-center flex">
        ...
        <section className="md:bg-[#717591] bg-white py-16 px-4 md:h-[652px] flex items-center justify-center rounded-[8px]">
          <div className="bg-white md:h-[524px]  rounded-xl max-w-7xl mx-auto w-full md:p-6 md:p-12">
            <div className="grid md:grid-cols-2 gap-8 items-center  px-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {stats.map((stat, index) => (
                  <div
                    key={index}
                    className={`rounded-2xl md:my-0 my-3 p-4 shadow-md w-full border-[1px] border-[#E1E4ED] md:border-[#6D758F] h-[80px] md:h-[180px] flex md:flex-col items-center md:items-center md:justify-center md:p-6 md:min-h-[140px] gap-4
        ${
          index === 1 || index === 3
