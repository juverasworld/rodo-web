...
//       role: isBusinessClient ? "business" : "client", // Added role field
//     };
...
export default function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const apiPayload = {
      ...
      phone: formData.phone,
      password: formData.password,
      role: isBusinessClient ? "business" : "client",
    };
                  ...
                  <>
                    <div>
                      ...
                      <input
                        ...
                        value={businessForm.companyName}
                        onChange={handleChange}
                        className="mt-1 block w-full rounded-md border border-[#F0F0F0] p3 focus:outline-none focus:ring-2 focus:ring-[#6D758F]"
                      />
                      {errors.companyName && (
                        <p className="text-red-500 text-sm mt-1">
                          {errors.companyName}
