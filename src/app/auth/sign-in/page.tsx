...
//               <h2 className="text-4xl font-bold text-[#6D758F] text-center mb-8">
//                 <Image
//                   src="/logo.svg"
//                   width={100}
//                   height={100}
...
//                 <div className="flex bg-gray-200 rounded-full p-1 w-full max-w-sm">
//                   <button
//                     type="button"
//                     onClick={() => setIsBusinessClient(false)}
//                     className={`flex-1 py-2 rounded-full font-semibold ${
//                       !isBusinessClient
//                         ? "bg-[#F0F0F0] text-white"
//                         : "text-gray-600"
//                     }`}
//                   >
//                     Private Client
...
// interface PrivateClientFormData {
//   fullName: string;
//   email: string;
//   phone: string;
//   password: string;
...
//   const [privateFormData, setPrivateFormData] = useState<PrivateClientFormData>(
//     {
//       fullName: "",
//       email: "Omitoyinayomide20@gmail.com",
//       phone: "",
...
//     useState<BusinessClientFormData>({
//       businessName: "",
//       businessEmail: "",
//       phone: "",
//       registerNumber: "",
...
//     if (isBusinessClient) {
//       setBusinessFormData((prev) => ({ ...prev, [name]: updatedValue }));
//     } else {
//       setPrivateFormData((prev) => ({ ...prev, [name]: updatedValue }));
//     }
//   };

//   const validate = (): FormErrors => {
//     const newErrors: FormErrors = {};
//     const data = isBusinessClient ? businessFormData : privateFormData;

//     const requiredFields = isBusinessClient
//       ? [
//           "businessName",
//           "businessEmail",
//           "phone",
...
//       if (!data[field as keyof typeof data]?.toString().trim())
//         newErrors[field] = `${field.replace(/([A-Z])/g, " $1")} is required`;
//     });

//     if (data.password !== data.confirmPassword)
//       newErrors.confirmPassword = "Passwords do not match";
//     if (!data.agreed) newErrors.agreed = "You must agree to the terms";
//     return newErrors;
//   };
...
//         "/api/signup",
//         isBusinessClient ? businessFormData : privateFormData
//       );
//       console.log("Signup success:", response.data);
//     } catch (error) {
//       console.error("Signup failed:", error);
...
//       <div className="hidden lg:flex lg:w-1/2 flex-col justify-center bg-gray-100 p-12 rounded-r-3xl">
//         <h1 className="text-4xl font-bold text-gray-800 mb-6 leading-tight">
//           Find skilled artisans <br /> and trusted freelancers for your projects
//         </h1>
...
//                 onClick={() => setIsBusinessClient(false)}
//                 className={`flex-1 py-2 rounded-full font-semibold ${
//                   !isBusinessClient ? "bg-gray-500 text-white" : "text-gray-600"
//                 }`}
//               >
//                 Private Client
//               </button>
...
//                   value={businessFormData.registerNumber}
//                   onChange={handleChange}
//                   className="block w-full p-3 border rounded"
//                 />
...
//                   value={privateFormData.fullName}
//                   onChange={handleChange}
//                   className="block w-full p-3 border rounded"
//                 />
//                 {errors.fullName && (
...
//                   readOnly
//                   className="block w-full p-3 border rounded bg-gray-100"
//                 />
...
//                 checked={
//                   isBusinessClient
//                     ? businessFormData.agreed
//                     : privateFormData.agreed
//                 }
//                 onChange={handleChange}
//                 className="h-4 w-4 text-gray-600"
//               />
...
//             <button
//               type="submit"
//               className="w-full bg-gray-500 hover:bg-gray-600 text-white font-semibold py-3 rounded-md shadow-md"
//             >
//               Continue
//             </button>
//           </form>
